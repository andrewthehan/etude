...
public class CircularIteratorTest {
  ...
  public void testReverse() {
    int[] intValues = new int[] { 0, 1, 2 };
    CircularIterator<Integer> intIt = CircularIterator.of(intValues).reverse();
    for (int i = 0; i < 10; ++i) {
      assertTrue(0 == intIt.next());
      assertTrue(2 == intIt.next());
      assertTrue(1 == intIt.next());
    ...
    intValues = new int[] { 0, 1, 2, 3, 4, 5 };
    intIt = CircularIterator.of(intValues).reverse();
    for (int i = 0; i < 30; ++i) {
      assertTrue(0 == intIt.next());
      assertTrue(5 == intIt.next());
      assertTrue(4 == intIt.next());
      assertTrue(3 == intIt.next());
      assertTrue(2 == intIt.next());
      assertTrue(1 == intIt.next());
    }
    intIt = CircularIterator.of(intValues).reverse().reverse();
    for (int i = 0; i < 30; ++i) {
      assertTrue(0 == intIt.next());
      assertTrue(1 == intIt.next());
      assertTrue(2 == intIt.next());
